...
TermFormatter::Formatter Application::s_green =
    TermFormatter::Formatter({TermFormatter::FG_Green});
TermFormatter::Formatter Application::s_red =
    TermFormatter::Formatter({TermFormatter::FG_Red});
TermFormatter::Formatter Application::s_reset =
    TermFormatter::Formatter({TermFormatter::ResetAll});
...
Application::~Application() { delete m_graphics; }
...
void Application::run() {
    ...
    while (running) {
        ...
        if (m_handler.keyDown[EventHandler::keys::ESC] ||
            m_graphics->Window()->isHidden()) {
            running = false;
        }
