...
public:
    ...
    Window(const std::string& name, size_t height, size_t width,
           int sdlWindowFlags = DefaultWindowFlags());
    ~Window();
    ...
    /// Returns the default window flags: SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN |
